// Social Icons - Updated October 6, 2024
function noop() { }
...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "svelte-3moisj");
			attr(li, "class", "svelte-3moisj");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			const icon_changes = {};
			if (dirty & /*social*/ 1) icon_changes.icon = /*icon*/ ctx[3];
			icon.$set(icon_changes);

			if (!current || dirty & /*social*/ 1 && a_href_value !== (a_href_value = /*link*/ ctx[2].url)) {
				attr(a, "href", a_href_value);
			}

			if (!current || dirty & /*social*/ 1 && a_aria_label_value !== (a_aria_label_value = /*link*/ ctx[2].label)) {
...
class Component extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { props: 1, social: 0 });
	}
}
