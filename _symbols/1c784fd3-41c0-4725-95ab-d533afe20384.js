// Site Navigation (copy) - Updated October 6, 2024
function noop() { }
const identity = x => x;
...
function get_each_context_5(ctx, list, i) {
	const child_ctx = ctx.slice();
	child_ctx[30] = list[i].link;
	child_ctx[40] = list[i].icon;
	return child_ctx;
}

// (400:4) {#each social as {link, icon}}
function create_each_block_5(ctx) {
	...
	let t;
	let current;
	icon = new Component$1({ props: { icon: /*icon*/ ctx[40] } });
	...
	return {
		...
		h() {
			...
			attr(a, "aria-label", a_aria_label_value = /*link*/ ctx[30].label);
			attr(a, "class", "svelte-l8sb3e");
			attr(li, "class", "svelte-l8sb3e");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			const icon_changes = {};
			if (dirty[0] & /*social*/ 2) icon_changes.icon = /*icon*/ ctx[40];
			icon.$set(icon_changes);

			if (!current || dirty[0] & /*social*/ 2 && a_href_value !== (a_href_value = /*link*/ ctx[30].url)) {
				attr(a, "href", a_href_value);
			}

			if (!current || dirty[0] & /*social*/ 2 && a_aria_label_value !== (a_aria_label_value = /*link*/ ctx[30].label)) {
...
function create_else_block_1(ctx) {
	let div;
	let button;
	let t0_value = /*link*/ ctx[30].label + "";
	let t0;
	let t1;
	...
	function select_block_type_2(ctx, dirty) {
		if (/*hovered_link*/ ctx[5] == /*link*/ ctx[30]) return 0;
		return 1;
	}
	...
	function mouseover_handler(...args) {
		return /*mouseover_handler*/ ctx[14](/*link*/ ctx[30], ...args);
	}
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-l8sb3e");
			attr(div, "class", "subnav-container svelte-l8sb3e");
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if ((!current || dirty[0] & /*site_nav*/ 4) && t0_value !== (t0_value = /*link*/ ctx[30].label + "")) set_data(t0, t0_value);
...
// (419:12) {#if !submenu || !submenu.length}
function create_if_block_5(ctx) {
	let a;
	let t_value = /*link*/ ctx[30].label + "";
	let t;
	let a_href_value;
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-l8sb3e");
			attr(a, "href", a_href_value = /*link*/ ctx[30].url);
			toggle_class(a, "active", /*link*/ ctx[30].url === window.location.pathname);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*site_nav*/ 4 && t_value !== (t_value = /*link*/ ctx[30].label + "")) set_data(t, t_value);

			if (dirty[0] & /*site_nav*/ 4 && a_href_value !== (a_href_value = /*link*/ ctx[30].url)) {
				attr(a, "href", a_href_value);
			}

			if (dirty[0] & /*site_nav*/ 4) {
				toggle_class(a, "active", /*link*/ ctx[30].url === window.location.pathname);
			}
		},
		i: noop,
...
function create_else_block_2(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "hidden link svelte-l8sb3e");
			attr(a, "href", a_href_value = /*link*/ ctx[30].url);
			toggle_class(a, "active", /*link*/ ctx[30].url === window.location.pathname);
		},
		m(target, anchor) {
...
// (424:16) {#if hovered_link == link}
function create_if_block_6(ctx) {
	let nav;
	let nav_transition;
	let current;
	let each_value_4 = /*submenu*/ ctx[31];
	let each_blocks = [];
	...
	return {
		...
		h() {
			attr(nav, "class", "subnav svelte-l8sb3e");
		},
		m(target, anchor) {
		...
		i(local) {
			...
			add_render_callback(() => {
				if (!current) return;
				if (!nav_transition) nav_transition = create_bidirectional_transition(nav, slide, { duration: 300 }, true);
		...
		o(local) {
			if (!nav_transition) nav_transition = create_bidirectional_transition(nav, slide, { duration: 300 }, false);
...
// (418:8) {#each site_nav as { link, submenu }}
function create_each_block_3(ctx) {
	...
	function select_block_type_1(ctx, dirty) {
		if (!/*submenu*/ ctx[31] || !/*submenu*/ ctx[31].length) return 0;
		return 1;
	}
...
function create_else_block(ctx) {
	...
	let nav_transition;
	let current;
	let each_value_2 = /*submenu*/ ctx[31];
	let each_blocks = [];
	...
	return {
		...
		h() {
			attr(button, "class", "mobile-subnav-title svelte-l8sb3e");
			attr(button, "type", "button");
			attr(nav, "class", "mobile-subnav svelte-l8sb3e");
		},
		m(target, anchor) {
...
// (467:12) {#if !submenu || !submenu.length}
...
// (466:8) {#each site_nav as { link, submenu }}
...
// (493:4) {#if searchResults.length}
function create_if_block(ctx) {
	let div;
	let ul;
	let div_intro;
	let each_value = /*searchResults*/ ctx[8];
	let each_blocks = [];
	...
	return {
		...
		h() {
			attr(div, "class", "searchResults svelte-l8sb3e");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
		...
		p(ctx, dirty) {
			if (dirty[0] & /*currentLang, searchResults*/ 264) {
				each_value = /*searchResults*/ ctx[8];
				let i;
...
// (496:10) {#each searchResults as result}
function create_each_block(ctx) {
	let li;
	let a;
	let t0_value = /*result*/ ctx[27].item.title + "";
	let t0;
	let a_href_value;
	let t1;
	...
	return {
		...
		h() {
			attr(a, "href", a_href_value = "" + ((/*currentLang*/ ctx[3] == 'en' ? '/en' : '') + "/" + /*result*/ ctx[27].item.url));
			attr(a, "class", "svelte-l8sb3e");
			attr(li, "class", "svelte-l8sb3e");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*searchResults*/ 256 && t0_value !== (t0_value = /*result*/ ctx[27].item.title + "")) set_data(t0, t0_value);

			if (dirty[0] & /*currentLang, searchResults*/ 264 && a_href_value !== (a_href_value = "" + ((/*currentLang*/ ctx[3] == 'en' ? '/en' : '') + "/" + /*result*/ ctx[27].item.url))) {
				attr(a, "href", a_href_value);
			}
		},
		d(detaching) {
...
function create_fragment(ctx) {
	...
	let t8;
	let button1;
	let t9_value = /*otherLang*/ ctx[9].toUpperCase() + "";
	let t9;
	let t10;
	let t11;
	let div5;
	...
	let if_block2 = /*mobileNavOpen*/ ctx[7] && create_if_block_1(ctx);
	...
	let if_block3 = /*searchResults*/ ctx[8].length && create_if_block(ctx);
	...
	return {
		...
		l(nodes) {
			...
			button0 = claim_element(div3_nodes, "BUTTON", { id: true, "aria-label": true });
			...
			t9 = claim_text(button1_nodes, t9_value);
		...
		h() {
			attr(ul, "class", "socials svelte-l8sb3e");
			attr(div0, "class", "top-bar svelte-l8sb3e");
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-l8sb3e");
			option0.__value = "tr";
			...
			attr(select, "class", "svelte-l8sb3e");
			if (/*currentLang*/ ctx[3] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[15].call(select));
			attr(div1, "class", "language-picker svelte-l8sb3e");
			attr(nav, "class", "svelte-l8sb3e");
			attr(div2, "class", "desktop-nav svelte-l8sb3e");
			attr(a1, "href", "/");
			attr(a1, "class", "logo svelte-l8sb3e");
			attr(button0, "id", "open");
			attr(button0, "aria-label", "Open mobile navigation");
			attr(button1, "class", "lang-swither-mobile svelte-l8sb3e");
			attr(div3, "class", "mobile-actions-container svelte-l8sb3e");
			attr(div4, "class", "mobile-nav svelte-l8sb3e");
			attr(input, "class", "search svelte-l8sb3e");
			attr(input, "type", "text");
			attr(input, "placeholder", "search");
			attr(div5, "class", "flex search-container svelte-l8sb3e");
			attr(header, "class", " svelte-l8sb3e");
		},
		m(target, anchor) {
			...
			append_hydration(option0, t3);
			append_hydration(select, option1);
			append_hydration(option1, t4);
			append_hydration(select, option2);
			append_hydration(option2, t5);
			select_option(select, /*currentLang*/ ctx[3], true);
			...
			append_hydration(header, t13);
			if (if_block3) if_block3.m(header, null);
			current = true;

			if (!mounted) {
				dispose = [
					listen(window_1, "mousemove", /*handleMouseout*/ ctx[10]),
					...
					listen(button1, "click", /*toggleMobileLangChange*/ ctx[11]),
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*site_nav, hovered_link, hovered_link_container*/ 100) {
			...
			if (dirty[0] & /*currentLang*/ 8) {
				select_option(select, /*currentLang*/ ctx[3]);
			}
			...
			if ((!current || dirty[0] & /*otherLang*/ 512) && t9_value !== (t9_value = /*otherLang*/ ctx[9].toUpperCase() + "")) set_data(t9, t9_value);

			if (/*mobileNavOpen*/ ctx[7]) {
				if (if_block2) {
					if_block2.p(ctx, dirty);

					if (dirty[0] & /*mobileNavOpen*/ 128) {
			...
			if (/*searchResults*/ ctx[8].length) {
				if (if_block3) {
					if_block3.p(ctx, dirty);

					if (dirty[0] & /*searchResults*/ 256) {
...
function instance($$self, $$props, $$invalidate) {
	...
	const sitemap_en = [
		...
		{
			"title": "Our Representative Offices",
			"url": "our-representations"
		},
	...
	const sitemap = [
		...
		{ "title": "Blog", "url": "blog" },
		{
			"title": "Uygulamalı Felsefe Nedir",
			"url": "uygulamali-felsefe-nedir"
		},
		{
	...
	onMount(() => {
		const currentUrl = new URL(window.location.href);
		$$invalidate(3, currentLang = currentUrl.pathname.split('/')[1] == 'en' ? 'en' : 'tr');
	}); /* 
...
*/
	...
	const fuse = new Fuse(currentLang == 'en'
		? sitemap_en
		: currentLang == 'it' ? sitemap_it : sitemap,
	{ keys: ['title'] });

	function _search() {
		$$invalidate(8, searchResults = fuse.search(searchQuery));
	}
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*currentLang*/ 8) {
			$$invalidate(9, otherLang = currentLang == 'tr' ? 'en' : 'tr');
		}

		if ($$self.$$.dirty[0] & /*searchQuery*/ 16) {
			if (searchQuery) {
				search();
			} else {
